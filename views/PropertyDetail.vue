        ...
        <div class="reviews-list">
          <div v-for="r in reviews" :key="r.userId" class="review-item">
            <div class="review-avatar">
              <el-avatar :size="40" :style="{ background: r.avatarColor }">{{ reviewAvatar(r.userId) }}</el-avatar>
            </div>
            <div class="review-body">
              <div class="review-header">
                <span class="review-user">{{ anonymizeReviewUserId(r.userId) }}</span>
...
const reviews: Review[] = [
  { userId: '100876', avatarColor: '#FF6B35', rating: 5, date: '2026-06-20', text: '房间很干净，采光好，房东人很 nice。地铁就在楼下，非常方便。', reply: '感谢认可，欢迎随时联系。' },
  { userId: 'E20491', avatarColor: '#67c23a', rating: 4.5, date: '2026-06-15', text: 'Great location and friendly landlord. The apartment has everything I need for my study abroad year.', reply: 'Thanks! Happy to help with your stay.' },
  { userId: '300512', avatarColor: '#409eff', rating: 4, date: '2026-06-08', text: '配套齐全，周边买菜方便。唯一建议是洗衣机可以换个新的。', reply: '' },
  { userId: '890341', avatarColor: '#e6a23c', rating: 5, date: '2026-05-28', text: '第三次租了，每次体验都很好。平台服务也很到位，推荐。', reply: '感谢老客户的支持。' },
]

function anonymizeReviewUserId(userId: string): string {
  const first = userId.trim().charAt(0)
  return first ? `ID ${first}***` : 'ID *'
}

function reviewAvatar(userId: string): string {
